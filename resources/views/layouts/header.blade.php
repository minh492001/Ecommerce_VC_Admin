    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/list') }}" class="nav-link @if(Request::segment(1) == "admin") active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ url('user/list') }}" class="nav-link @if(Request::segment(1) == "user") active @endif">
                        <i class="nav-icon fas fa-user"></i>
                        <p>
                            User
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ url('company/list') }}" class="nav-link @if(Request::segment(1) == "company") active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ url('product/list') }}" class="nav-link @if(Request::segment(1) == "product") active @endif">
                ...
                @if(Auth::user()->is_admin == 1 && Auth::user()->company_id == 1)
                <li class="nav-item">
                    <a href="{{ url('orders/list') }}" class="nav-link @if(Request::segment(1) == "orders") active @endif">
                        <i class="nav-icon fas fa-list-alt"></i>
                        <p>
                            Orders
                        </p>
